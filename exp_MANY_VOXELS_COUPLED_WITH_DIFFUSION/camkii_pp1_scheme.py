...
def init_pools( compt ):
    ...
    if args['enable_subunit_exchange']:
        ...
        molecules_[ pool_name(compt, 'x0y7') ].nInit = args['camkii']/2.0/args['num_voxels']
        molecules_[ pool_name(compt, 'x0y6') ].nInit = args['camkii']/2.0/args['num_voxels']
    else:
    ...
    molecules_[ pool_name(compt, 'PP1') ].nInit = args['pp1']/args['num_voxels']
    molecules_[ pool_name(compt, 'I1PPP1') ].nInit = 0
    _logger.info('Total PP1 %s' % molecules_[pool_name(compt,'PP1')].nInit )
    _logger.info('Total I1PPP1 %s' % molecules_[pool_name(compt,'I1PPP1')].nInit )
