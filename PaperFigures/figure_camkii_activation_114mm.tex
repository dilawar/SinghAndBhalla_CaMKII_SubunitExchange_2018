...
\documentclass[varwidth=114mm,class=../pnas-new]{standalone}
\usepackage{tikz}
\usepackage{tabularx}
...
\begin{tabularx}{\figW cm}{X X X}
    ...
    \begin{tikzpicture}
        \begin{loglogaxis}[
            ...
            , width = \plotW cm
            , height = \plotH cm
            , legend style={at={(-0.4,1.1)}, anchor=south west, anchor=south west , font=\tiny}
            , legend columns=2
