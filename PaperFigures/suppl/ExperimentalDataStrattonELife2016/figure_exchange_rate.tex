    ...
    \begin{tikzpicture}[scale=1, baseline]
        \begin{axis}[ xlabel=Time, x unit=min
            ...
            \addplot+[no marks, thick] gnuplot[raw gnuplot] {
                set datafile separator ",";
                plot "../UsingChemReacs/CM1e-3_rg0.10608183551394483_rl0.14384498882876628.csv"
                    using "time":"colocalization_perc" every 20;
            };
            \addplot+[no marks, thick] gnuplot[raw gnuplot] {
                set datafile separator ",";
                plot "../UsingChemReacs/CM8e-3_rg0.10608183551394483_rl0.14384498882876628.csv"
                    using "time":"colocalization_perc" every 20;
            };
            \addplot+[no marks, thick] gnuplot[raw gnuplot] {
                set datafile separator ",";
                plot "../UsingChemReacs/CM100e-3_rg0.10608183551394483_rl0.14384498882876628.csv"
                    using "time":"colocalization_perc" every 20;
            };
