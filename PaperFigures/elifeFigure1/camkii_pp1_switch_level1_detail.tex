...
\documentclass[9pt, crop,tikz,class=../elife]{standalone}
...
\begin{tikzpicture} [ node distance=3cm
        , Species/.style = { inner sep=2pt, circle, shading=ball, ball color=green!80 }
        ...
        , CaM/.style = { star,  minimum size=1.5cm, star points = 4
            , star point ratio=2 }
        , every path/.style = { -latex, very thick}
    ...
    \begin{scope}
        ...
        \foreach \i in {1,2,3,4} {
            \node[Species] (ca\i) at (cacam.outer point \i) {};
        }
        ...
        \draw[-stealth, line width=2.5pt] (cam) to[] node[] (binding) {} (cacamComplex);

        %% Draw an incoming calcium
        \node[Species, label=Ca\textsuperscript{++}] (incomingCa) 
            at ([yshift=1cm,xshift=-1cm]binding) {};
    ...
    \begin{scope}
        ...
        \draw[-latex, shorten <>= 0.1cm] (camkii0) 
            edge  node[Process] (phospho1) {} (camkii1);


        \draw[-latex, shorten <>= 0.1cm, line width=2.5pt] (camkii1) 
