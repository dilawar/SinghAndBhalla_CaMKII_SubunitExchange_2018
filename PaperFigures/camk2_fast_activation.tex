...
\begin{tikzpicture}
    ...
    \CAMKIIA{camkii2}{(0,0)}{1,6}{0.5}{6};
    \CAMKIIA{camkii3}{([xshift=3cm]camkii2)}{1,6,5}{\r}{6};
    \CAMKIIA{camkii4}{([xshift=3cm]camkii3)}{1,6,5,4}{\r}{6};
    \CAMKIIA{camkii5}{([xshift=3cm]camkii4)}{1,6,5,4,3}{\r}{6};
    \CAMKIIA{camkii6}{([xshift=3cm]camkii5)}{1,6,5,4,3,2}{\r}{6};

    \edef\rd{0.7}
    \edef\rr{0.3}
    \CACAM{c1}{[shift=(-60:\rd)]camkii2}{\rr};
    \CACAM{c2}{[shift=(-120:\rd)]camkii3}{\rr};
    \CACAM{c3}{[shift=(-180:\rd)]camkii4}{\rr};
    \CACAM{c4}{[shift=(-240:\rd)]camkii5}{\rr};
