...
\documentclass[10pt,multi=false,class=../elife]{standalone}
\usepackage{pgfplots}
...
\begin{tikzpicture}[ scale=1 ]
    \begin{axis}[ name=A
        ...
        \addplot+ [no marks,blue] gnuplot [ raw gnuplot ] {
            plot "./CaM12_PP192_voxels1_suON.dat_processed.dat"
            using (column("time")/86400):(1.5+column("CaMKII*")/12) every 10;
        };
        \addplot+ [no marks,red] gnuplot [ raw gnuplot ] {
            plot "./CaM12_PP120_voxels1_suOFF.dat_processed.dat"
    ...
    \begin{axis}[ name=C, xshift=25mm
        ...
        \legend{+SE,,,,-SE}
    \end{axis} 
    \node[xshift=15mm, yshift=10mm] (labelc) at (C.north west) {\bf C};
