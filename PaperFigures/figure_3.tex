...
\begin{tabularx}{\figW cm}{X X}
    ...
    \begin{tikzpicture}[scale=1]
        \begin{semilogxaxis}[name=c1
            ...
            , legend columns=1
            , title={d=\SI{30}{\nano\meter}}
            , title style={at={(0.5,1.5)}}
            , ymin=0, ymax=18
            ]
            \addplot[gray,thick, error bars/.cd, y dir=both,y explicit] table 
                [col sep=comma,x=D, y=Mean CaMKII, y error=Std CaMKII]{su_spread_activation_n9.csv};
            \addplot[black,thick, error bars/.cd, y dir=both,y explicit] table 
        ...
        \end{semilogxaxis}
        \node[above=of c1.north west, yshift=0mm,xshift=-5mm] {\bf C};
        \begin{semilogxaxis}[ name=c2
    ...
    \begin{tikzpicture}[scale=1]
        ...
        \begin{semilogxaxis}[name=f2
            % , at={(f1.south west)}, anchor=north west, yshift=-10mm
            , change y base=true
