...
\documentclass[crop=true,multi=false,varwidth=8.7cm,class=../pnas-new]{standalone}
...
\begin{tabularx}{\figW cm}{X X}
    ...
    \begin{tikzpicture}[scale=1]
        \begin{semilogxaxis}[name=f1
            ...
            , height=\HEIGHT %, width=1.15*\WidthImage
            , enlargelimits
