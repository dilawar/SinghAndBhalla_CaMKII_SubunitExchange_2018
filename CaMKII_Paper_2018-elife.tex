...
From these values, we chose a combination of $r_g$ and $r_l$ which best 
explained the concentration dependant changes in the rate of colocalization
...
reasonably well for $r_l$ and $r_g$. Note that we do not model
