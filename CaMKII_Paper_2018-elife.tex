...
(see \nameref{sec:materials_and_methods}). This leads to many more reactions
...
\begin{figure}[t]%[hbt] 
    \includegraphics[width=0.95\linewidth]{./elifeFigure1.pdf}
...
\begin{figure}[ht]
    \includegraphics[width=140mm]{elifeFigure2.pdf}
...
\gls{camkii} holoenzymes during subunit exchange \EQ{losegainx}) that can exist
...
red sigmoidal fit in \FIG{tolerance_pp1}B). A similar trend was observed for
...
(\EQ{losegainx}) turn unphosphorylated holoenzymes to phosphorylated holoenzymes
...
inactive holoenzyme (\EQ{turnover}), thus decreasing the stability of the
...
turnover (\FIG{turnover}B), after which subunit exchange could not phosphorylate
...
\begin{figure}[th!]
    \includegraphics[width=114mm]{./elifeFigure3.pdf}
...
significant \gls{camkii} activity (\FIG{subunit_facilitates_spread}B, red
...
(\FIG{subunit_facilitates_spread}C, black curve).

The first step of \gls{camkii} phosphorylation (\EQ{phospho}) is slow since it
...
adding an available phosphorylated subunit to it (\EQ{losegainx}). Note that a
...
up available active subunits (given in \EQ{losegainx}) is faster than $v_1$.
...
(compare red and blue with the rest in \FIG{subunit_facilitates_spread}D). 
...
\begin{figure}
    \includegraphics[width=0.95\linewidth]{./elifeFigure4.pdf}
...
}{\includegraphics[width=\linewidth]{./elifeFigure4_supp1.pdf}}
...
\begin{figure}%[t]%[bth] 
    \includegraphics[width=0.95\linewidth]{./elifeFigure5.pdf}
...
\begin{figure}%[t]%[tbh]
    \includegraphics[width=11.4cm]{elifeFigure6.pdf}
...
% CaMKII shows diverse timescales of activity.
\begin{table}[tb]
...
(\TABLE{diverse_timescales}) -- has important theoretical implications. A very
...
phosphorylation of \gls{camkii} is given by \EQ{phospho}
...
exchange (\EQ{losegainx}). We treat these as independent variables. The
...
(\nameref{sec:materials_and_methods}) to be in the range of \SI{1}{\per\second}.
...
\begin{figure}[ht!]
    \includegraphics[width=0.95\linewidth]{./elifeFigure7.pdf}
...
\begin{figure}[ht!]
    \includegraphics[width=12cm]{./elifeFigure8.pdf}
    ...
    \figsupp[\gls{pp1} potency reduces as \SUB{D}{PP1} increases.]{CaMKII/PP1
        ...
        increased \SUB{D}{PP1} therefore non-uniform distribution of \gls{pp1} in
        ...
        simulation divided by the simulation time in hours. On top, dashed blue
        line (labeled \textcolor{blue}{\SUB{D}{PP1}=0}) represents the case
        where \gls{pp1} was not allowed to diffuse. At bottom, dashed blue line
...
}{\includegraphics[width=\linewidth]{./elifeFigure8_supp1.pdf}}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{./elifeFigureSI1.pdf}
...
\begin{center}
    \includegraphics[width=\linewidth]{elifeFigureSI2.pdf}\label{si:fig:discretization}
