...
\begin{figure}
    ...
    \caption{Subunit exchange facilitates the spread of kinase activity
        ...
        deviation.  \textbf{(F)} In contrast with previous result, long-time average 
        \gls{camkii} activity (\SUB{N}{CaMKII}=6, simulation time=10 days) is 
        independent of \SUB{D}{sub}, and only depends on \SUB{D}{PP1}. 
        Black dots represent bistable configurations with at least
