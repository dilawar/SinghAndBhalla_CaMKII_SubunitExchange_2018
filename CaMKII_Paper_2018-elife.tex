...
\EQ{losegainx} where $0\le a \le 6\text{ or }7$.
...
is the number of holoenzymes in the system.  \todo{estimate subunit-exchange rate using
experiment data from \citep{stratton_activation-triggered_2014}.}
