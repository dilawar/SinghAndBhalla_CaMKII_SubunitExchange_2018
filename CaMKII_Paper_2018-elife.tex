...
were mixed together. Upon subunit exchange, a holoenzyme may have both color
subunits. The readout from this assay is ``cololocalization'' which is the
fraction of total holoenzymes containing subunits of both colors.

In our simulation of this assay, a \gls{camkii} holoenzyme is represented by
...
\cite{stratton_activation-triggered_2014}, our model captures the time-scale
and concentration dependant decrease in colocalization rate reasonably well.
